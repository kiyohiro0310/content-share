...
const CommentForm = ({
  ...
  return (
    <form onSubmit={submitHandler} className="flex space-x-4 w-full">
      ...
      <button type="submit" className="px-8 py-2 bg-black text-teal-700 font-bold rounded-lg hover:bg-teal-700 hover:text-black transition-all duration-200 cursor-pointer">
        Post
      </button>
    </form>
  );
